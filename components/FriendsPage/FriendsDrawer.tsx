...
function FriendsDrawer() {
  ...
  return (
      <View style={{ padding: 10, flex: 1 }}>
        <UsersList
          sentFriendsList={sentFriendsRequest as Array<UserList>}
          receivedFriendsRequest={receivedFriendsRequest as Array<UserList>}
          friendsList={friendsList as Array<UserList>}
        />
      </View>
  );
}
